...
def data_loader(cfg:DictConfig) -> Union[Dataset, DatasetDict]:
  ...
  if cfg.source_type.lower() == "hf":
    dataset = load_ner_dataset(cfg.hf_path, source_type=cfg.source_type.lower()) 
  elif cfg.source_type.lower() == "local":
    dataset = load_ner_dataset(cfg.data_folder, source_type=cfg.source_type.lower(), file_type=cfg.file_type)
