...
def rename_ent(
    ent_col: Union[Column, List[List[str]], List[List[Dict]]],
    rename_map: Dict[str, str],
    is_iob: Union[bool, None]=None,
    ent_label_key: Union[str, None]=None,
    *,
    dataset_format: str
) -> Union[List[List[str]],
...
def __rename_spacy_like_df(
    ent_col:List[List[Dict[str, str]]], 
    rename_map:Dict[str, str], 
    ent_label_key:str
...
def __validate_col_struc(
    obj:Union[List[List[str]], List[List[Dict]]], 
    inner_type:Type, 
    name:str
    )-> None:
    """
